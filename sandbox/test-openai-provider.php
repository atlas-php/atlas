...
test('streaming surfaces thinking deltas for live display', function () {
    // A harder prompt at Medium effort reliably produces reasoning summaries
    // (OpenAI emits them best-effort — trivial prompts may skip them).
    $stream = Atlas::text(Provider::OpenAI, 'gpt-5')
        ->reasoning(ReasoningEffort::Medium, includeSummary: true)
