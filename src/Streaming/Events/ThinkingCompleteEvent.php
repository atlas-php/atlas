...
/**
 * Event emitted when model thinking/reasoning completes.
 *
 * Indicates the end of a model's internal reasoning process,
 * used with models that support extended thinking.
 */
final readonly class ThinkingCompleteEvent extends StreamEvent
{
    /**
