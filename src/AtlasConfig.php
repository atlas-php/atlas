...
class AtlasConfig
{
    public function __construct(
        ...
        public readonly ?string $chunker = null,
        public readonly int $chunkSize = 512,
        public readonly int $chunkOverlap = 50,
    ...
    public static function fromConfig(): self
    {
        return new self(
            ...
            chunker: config('atlas.embeddings.chunker'),
            chunkSize: (int) config('atlas.embeddings.chunk_size', 512),
            chunkOverlap: (int) config('atlas.embeddings.chunk_overlap', 50),
