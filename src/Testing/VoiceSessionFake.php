...
/**
 * Fluent builder for creating fake VoiceSession objects in tests.
 */
class VoiceSessionFake
{
    protected string $sessionId;

    protected string $provider = 'openai';

    protected string $model = 'gpt-4o-voice-preview';
    ...
    public function withTransport(VoiceTransport $transport): static
    {
    ...
    public function toResponse(): VoiceSession
    {
