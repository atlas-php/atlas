 ...
 * @method static \Illuminate\Support\Collection<int, \Atlasphp\Atlas\Embeddings\SearchResult> similaritySearch(class-string<\Illuminate\Database\Eloquent\Model> $model, string $query, array<string, mixed> $options = [])
 *
 * @see AtlasManager
 */
