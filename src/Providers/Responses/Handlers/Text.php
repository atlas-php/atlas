...
namespace Atlasphp\Atlas\Providers\Responses\Handlers;
...
/**
 * Base text handler for the OpenAI Responses API wire format.
 *
 * Concrete and provider-neutral: handles text generation, streaming with named
 * SSE events, structured output via json_schema, and the input-token endpoint.
 * Shared by OpenAI, xAI, and generic Responses-compatible proxies. Providers
 * subclass this and override only their seams (`buildPayload`, `countTokens`,
 * `extraHeaders`).
 */
class Text implements TextHandler
{
    ...
    public function __construct(
        ...
        protected readonly MediaResolverContract $media,
        protected readonly ToolMapperContract $toolMapper,
        protected readonly ResponseParserContract $parser,
    ) {}
