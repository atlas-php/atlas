...
|----------|-----|-------------|
| OpenAI | `openai` | Text, stream, structured, reasoning, image, audio, video, embed, moderate, voice, vision, tool calling |
| Anthropic | `anthropic` | Text, stream, structured, reasoning, vision, tool calling |
| Google | `google` | Text, stream, structured, reasoning, image, embed, vision, tool calling |
| xAI | `xai` | Text, stream, structured, reasoning, image, audio, video, voice, vision, tool calling |
